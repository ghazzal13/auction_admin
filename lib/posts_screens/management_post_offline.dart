...
class ManagmentPostOfflineScreen extends StatefulWidget {
  const ManagmentPostOfflineScreen({Key? key}) : super(key: key);

  @override
  _ManagmentPostOfflineScreenState createState() =>
      _ManagmentPostOfflineScreenState();
}

class _ManagmentPostOfflineScreenState
    extends State<ManagmentPostOfflineScreen> {
  @override
            ...
            CupertinoDialogAction(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ManagmentPostOfflineScreen(),
                    ),
                  );
                }),
            CupertinoDialogAction(
